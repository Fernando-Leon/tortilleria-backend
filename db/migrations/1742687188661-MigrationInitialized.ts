...
export class MigrationInitialized1742687188661 implements MigrationInterface {
    name = 'MigrationInitialized1742687188661'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`profile\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(30) NOT NULL, \`description\` varchar(70) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`INSERT INTO \`profile\` (\`name\`, \`description\`) VALUES ('Administrador', 'Perfil de administrador')`);
        await queryRunner.query(`INSERT INTO \`profile\` (\`name\`, \`description\`) VALUES ('Secretaria', 'Perfil de secretaria')`);
